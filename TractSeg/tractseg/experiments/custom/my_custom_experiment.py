...
class Config(TractSegConfig):
    ...
    DATASET_FOLDER = "/nas/longleaf/home/zyc626/TractSeg/tractseg/preproc"      # name of folder that contains all the preprocessed subjects (each subject has its own folder with the name of the subjectID)
