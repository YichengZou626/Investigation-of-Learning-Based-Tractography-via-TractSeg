...
class Config:
    ...
    # input data
    EXPERIMENT_TYPE = "peak_regression"  # tract_segmentation|endings_segmentation|dm_regression|peak_regression
    EXP_NAME = "HCP_TEST"
    EXP_MULTI_NAME = ""  # CV parent directory name; leave empty for single bundle experiment
    DATASET_FOLDER = "preproc"
    ...
    LABELS_FILENAME = "bundle_masks"  # autofilled
    LABELS_TYPE = "int"
